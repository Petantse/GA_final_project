$( document ).ready(function() {
    ...
    $("#work").click(function() {
          ...
          // }, 500);
          // show projects container
          $('.projects-container').addClass('slide-projects');
          // show project
          $('#tab1').addClass('show-project');
          $('#projects').css('display', 'flex');
          setTimeout(function(){
            $('#tab1').addClass('visibility').siblings().removeClass('show-project visibility');
            $('#projects').css('opacity', '1');
          }, 300);
          // $('#tab1').delay(800).addClass('show-project').siblings().removeClass('show-project');
          // activate tab label
          $('li[href="#tab1"]').addClass('active').siblings().removeClass('active');
    ...
    // show project
    $(section).addClass('show-project');
    setTimeout(function(){
      $(section).addClass('visibility').siblings().removeClass('show-project visibility');
    }, 100);
    // change tab color
